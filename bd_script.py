...
cnt_docs = len(os.listdir('/home/malkolmz/Рабочий стол/docs/vacancies'))
i = 0

# Проходимся по всем файлам в папке vacancies
for fl in os.listdir('/home/malkolmz/Рабочий стол/docs/vacancies'):

    # Открываем, читаем и закрываем файл
    f = open('/home/malkolmz/Рабочий стол/docs/vacancies/{}'.format(fl), encoding='utf8')
    jsonText = f.read()
    f.close()
...
eng = sql.create_engine('postgresql://postgres:6336@127.0.0.1:5432/HH_scraping')
conn = eng.connect()
